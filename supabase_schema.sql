...
create table if not exists public.acred_requisitos_eleam (
  ...
  notas                text,
  estado_modo          text not null default 'automatico'
                       check (estado_modo in ('automatico','manual')),
  estado_manual_motivo text,
  estado_manual_en     timestamptz,
  estado_manual_por    uuid references public.profiles(id) on delete set null,
...
-- ============================================================
-- TRAZABILIDAD INTEGRAL DEL RESIDENTE (cursor + auditoria DB)
-- ============================================================
...
-- Vigencia documental automática y excepciones manuales para Cumplimiento SEREMI.

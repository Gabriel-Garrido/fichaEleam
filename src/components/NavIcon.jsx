const ICONS = {
  ...
  staffing: (
    <>
      <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25m10.5-2.25v2.25M4.5 8.25h15m-13.5 0v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V8.25" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 12.75h7.5M8.25 16.5h4.5M16.5 12.75l1.5 1.5 3-3.75" />
    </>
  ),
  payment: (
  ...
  meds: (
    <>
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 21h-3a4.5 4.5 0 01-3.182-7.682l8.864-8.864a4.5 4.5 0 116.364 6.364l-8.864 8.864A4.486 4.486 0 0110.5 21z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 9.75l6 6" />
    </>
  ),
  permissions: (
...
export const NAV_ICON_IDS = Object.keys(ICONS);

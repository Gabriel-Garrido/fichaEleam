...
export default function ResidentForm() {
  ...
  const validate = () => {
    ...
    if (form.indice_barthel !== "" && (isNaN(form.indice_barthel) || form.indice_barthel < 0 || form.indice_barthel > 100)) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const msg = err?.code === "23505"
        ? "Ya existe un residente con ese RUT."
      ...
      <form onSubmit={handleSubmit} className="space-y-6" noValidate>
        ...
        <Card title="Datos Personales">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Field label="Previsión" name="prevision" placeholder="FONASA A / ISAPRE…" value={form.prevision} onChange={handleChange} />
          </div>
        </Card>
        ...
        <Card title="Información Clínica">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Field
              label="Alergias (separar con coma)"
              name="alergias" value={form.alergias} onChange={handleChange}
            ...
            <Field
              label="Índice de Barthel (0–100)" name="indice_barthel" type="number"
        ...
        {/* Datos de ingreso */}
        <Card title="Datos de Ingreso">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Field label="Fecha de ingreso *" name="fecha_ingreso" type="date" value={form.fecha_ingreso} onChange={handleChange} error={errors.fecha_ingreso} />

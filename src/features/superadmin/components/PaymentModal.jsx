  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Registrar pago">
      <form onSubmit={submit} className="space-y-3">
        <div>
          <label className="block text-xs uppercase font-semibold text-gray-500 mb-1">ELEAM *</label>
          <select
            value={form.eleam_id}
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="block text-xs uppercase font-semibold text-gray-500 mb-1">Monto CLP *</label>
            <input
              type="number" min="1"
              value={form.monto}
        ...
        <div>
          <label className="block text-xs uppercase font-semibold text-gray-500 mb-1">Método de pago</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-xs uppercase font-semibold text-gray-500 mb-1">Notas</label>
          <textarea
            value={form.notas}

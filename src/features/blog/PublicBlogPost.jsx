      ...
      <div className="max-w-5xl mx-auto px-5 py-12 flex flex-col lg:flex-row gap-12">
        <article className="flex-1 min-w-0">
          ...
          <header className="mb-8">
            ...
            <p className="text-lg text-slate-500 leading-relaxed mb-5">{post.resumen}</p>
            <div className="flex flex-wrap items-center gap-3 text-sm text-slate-400 border-t border-slate-100 pt-4">
              <span className="font-semibold text-slate-700">{post.autor_nombre ?? "Equipo FichaEleam"}</span>
              <span>·</span>
        ...
        <aside className="lg:w-64 shrink-0">
          <div className="sticky top-24 space-y-4">
            ...
            {toc && toc.length >= 3 && (
              <div className="bg-slate-50 border border-slate-100 rounded-xl p-4 hidden lg:block">

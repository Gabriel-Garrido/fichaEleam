 ...
 onClick={() => navigate("/")} className="text-2xl font-black text-teal-700 tracking-tight">
      ...
      <div className="bg-white rounded-2xl shadow-lg w-full max-w-md p-8">
        ...
        <form onSubmit={handleLogin} className="space-y-4" noValidate>
          <div>
            <label htmlFor="login-email" className="block text-xs font-medium text-slate-600 mb-1">Correo electrónico</label>
            <Input
              id="login-email"
              type="email"
              name="email"
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              <label htmlFor="login-password" className="block text-xs font-medium text-slate-600">Contraseña</label>
              <Link
                to="/recuperar-acceso"

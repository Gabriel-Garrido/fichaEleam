...
export const PERM_GROUPS = [
  ...
  },
  {
    ...
    perms: [
      ...
      { key: "validar_planes_cuidado",       label: "Confirmar revisión de dirección técnica" },
  ...
  },
  {
    label: "Medicamentos",
    featureId: "residents",
    description: "La indicación debe provenir de un profesional habilitado. Entrega sólo las tareas que correspondan al cargo y protocolo del ELEAM.",
    perms: [
      { key: "crear_indicaciones_medicamentos",  label: "Registrar tratamiento indicado" },
      { key: "editar_indicaciones_medicamentos", label: "Modificar tratamiento" },
      { key: "adjuntar_recetas_medicamentos",    label: "Adjuntar recetas" },
      { key: "administrar_medicamentos",         label: "Registrar administración" },
      { key: "validar_medicamentos_controlados", label: "Segunda firma de controlados" },
      { key: "ajustar_stock_medicamentos",       label: "Registrar recepción y stock" },
    ],
  },
  {
    label: "Entrega de turno",
    featureId: "residents",
    description: "Permite preparar la entrega operativa y consultar su historial trazable.",
    perms: [
      { key: "registrar_entregas_turno", label: "Registrar entregas" },
      { key: "ver_entregas_turno", label: "Ver historial" },
    ],
  },
  {
    label: "Cobranza",
...
export const DEFAULT_PERMS = {
  ...
  registrar_entregas_turno: true, ver_entregas_turno: true,
  crear_planes_cuidado: true, editar_planes_cuidado: true, validar_planes_cuidado: false, completar_tareas_cuidado: true,
  editar_indicaciones_cuidado: false,
  crear_indicaciones_medicamentos: false, editar_indicaciones_medicamentos: false,
  adjuntar_recetas_medicamentos: false,
...
export const PLANTILLAS_CARGO = {
  ...
  "Médico/a": {
    ...
    crear_indicaciones_medicamentos: true, editar_indicaciones_medicamentos: true,
    adjuntar_recetas_medicamentos: true,
    administrar_medicamentos: false, validar_medicamentos_controlados: true, ajustar_stock_medicamentos: false,
    asignar_camas: true,
    subir_acreditacion: true,  editar_acreditacion: true,  archivar_acreditacion: false,
    aplicar_evaluaciones_clinicas: true,
    crear_eventos_adversos: true, editar_eventos_adversos: true, cerrar_eventos_adversos: true,
  ...
  "Auxiliar ATD": {
    ...
    registrar_entregas_turno: true, ver_entregas_turno: true,
    crear_planes_cuidado: false, editar_planes_cuidado: false, validar_planes_cuidado: false, completar_tareas_cuidado: true,
    editar_indicaciones_cuidado: false,
    crear_indicaciones_medicamentos: false, editar_indicaciones_medicamentos: false,
    adjuntar_recetas_medicamentos: true,
    administrar_medicamentos: false, validar_medicamentos_controlados: false, ajustar_stock_medicamentos: false,
  ...
  "Administrativo/a": {
    ...
    registrar_entregas_turno: false, ver_entregas_turno: true,
    crear_planes_cuidado: false, editar_planes_cuidado: false, validar_planes_cuidado: false, completar_tareas_cuidado: false,
    editar_indicaciones_cuidado: false,
    crear_indicaciones_medicamentos: false, editar_indicaciones_medicamentos: false,
    adjuntar_recetas_medicamentos: false,
    administrar_medicamentos: false, validar_medicamentos_controlados: false, ajustar_stock_medicamentos: false,
